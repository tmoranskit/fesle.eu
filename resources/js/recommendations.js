...
var chromaticScale = [
    ...
    'I love ho you lead the training it super and it is perfectly prepared in terms of form"',
    ...
    '"Interesting approach (not only a good approach to recruitment, but also harmful techniques)"',
